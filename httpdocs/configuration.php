...
class JConfig
{
	...
	public $log_path = '/var/www/vhosts/klapptis.ch/httpdocs/administrator/logs';
	public $log_priorities = array (
'0' => 'all'
);
	public $mailer = 'mail';
	public $mailfrom = 'info@klapptisch.ch';
	public $mailonline = '1';
	public $massmailoff = '';
	...
	public $replytoname = '';
	public $robots = '';
	public $secret = '3MDsK937ixMIYgCMwK8e36tFqrVdOjIJ';
	public $sef = '1';
	public $sef_rewrite = '';
	public $sef_suffix = '';
	...
	public $session_metadata_for_guest = '1';
	...
	public $smtpuser = '';
	public $tmp_path = '/var/www/vhosts/klapptis.ch/httpdocs/tmp';
	public $unicodeslugs = '';
	public $user = 'klapptisch2023';
}
